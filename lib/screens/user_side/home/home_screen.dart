...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Widget> slides = [
    CarouselCard(
      ...
      circlecolor1: Color.fromARGB(255, 29, 70, 165),
      circlecolor2: Color.fromARGB(255, 29, 70, 165),
    ),
    CarouselCard(
      title: 'New Arrivals',
      subtitle: 'Premium Sneakers',
      description: 'Up to 30% off today',
      cardcolor: Color(0xFF004CFF),
      imagepath: 'assets/images/Watch4.png',
      circlecolor1: Color.fromARGB(255, 29, 70, 165),
      circlecolor2: Color.fromARGB(255, 29, 70, 165),
    ),
    CarouselCard(
                        ...
                        children: [
                          ...
                          if (secondIndex < categories.length)
                            CategoriesCard(
                              ...
                              productnum: categories[secondIndex]["amount"]
                                  .toString(),
