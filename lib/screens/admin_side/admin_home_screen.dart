...
class _AdminHomeScreenState extends State<AdminHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(
        children: [
         AdminCard(icon: Icon(Icons.gif_box_outlined), title: "Manage Categories", amount: "3 items", onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (_) => CategoriesScreen()));
         }),
         SizedBox(height: 10.h,),
         AdminCard(icon: Icon(Icons.wallet_giftcard_outlined), title: "Manage Products", amount: "4 items", onTap: (){}),
        ],
      ),) ),
    );
  }
